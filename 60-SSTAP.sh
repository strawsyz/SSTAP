...
#echo "$(date "+%Y.%m.%d-%H.%M.%S")"
python main.py --mode train --checkpoint_path ./checkpoint/Semi-base-0.6 --unlabel_percent 0.6 --batch_size 16  --train_epochs 5 #
...
#echo "$(date "+%Y.%m.%d-%H.%M.%S")"
#
#python main.py --mode train --checkpoint_path ./checkpoint/Semi-base-0.00 --unlabel_percent 0.0 --batch_size 16 --train_epochs 5 #
